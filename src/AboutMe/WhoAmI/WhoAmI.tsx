    ...
    return (
        <div className={s.infoExpertBlock}>
            <div className={s.info}>
                ...
                <p>A person who loves programming.              </p>
                    <p> Back in school, I wanted to become a programmer, but due to lack of information, I decided to go in a different direction.</p>
                    <p> I enjoy what I am doing now and plan to continue developing in this area.</p>
                    <p> The current referee of the EHF handball.</p>
